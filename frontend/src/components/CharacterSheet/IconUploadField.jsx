...
import { FileButton, Button, Group, Avatar, Text } from '@mantine/core';
import { notifications } from '@mantine/notifications';
import { useCharacterStore } from '../../store/useCharacterStore';

// Общее поле "картинка" — для аватара персонажа и для иконок действий/
// предметов, которые потом показываются в хотбаре боевой карты. Файл
// загружается на бэкенд, который его провалидирует и положит в
// uploads/characters/<id>/.
